                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${(item.quantity * (item.salePrice??0)) +(item.toppings?.map((e)=>(e.quantity??0) * e.toppingData.price).reduce((a,b)=> a+b)??0)} MDL',
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 18,
                                        fontFamily: 'Arial',
                              ...
                              IconButton(
                                icon: const Icon(Icons.delete, color: Colors.red),
                                onPressed: () {
                                  cart.removeFromCart(item.id!); // Folosește metoda nouă fără toppings
                                },
                              ),
                            ],
                          ),
